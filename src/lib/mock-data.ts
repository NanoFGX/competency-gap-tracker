...
export const recruiters: Recruiter[] = [
  {
    ...
    yearsExperience: 9,
    linkedIn: "linkedin.com/in/samuel-marc",
  },
  {
    id: "r2",
    name: "Sarah Mitchell",
    ...
    email: "s.mitchell@axiomdigital.io",
    location: "London, UK",
    ...
    yearsExperience: 6,
    linkedIn: "linkedin.com/in/sarah-mitchell-talent",
  },
  {
    id: "r3",
    name: "James Okafor",
...
export const evidence: Evidence[] = [
  {
    ...
    link: "github.com/aisha/inventory",
    competencies: ["Problem Solving", "Technical Writing"],
    status: "Approved",
  ...
  },
  {
    ...
    mentorFeedback: {
      ...
      date: "2025-11-15",
      comment:
        "Report quality has improved significantly since the previous submission. The benchmarking methodology is rigorous — three reproduced environments is the right approach. The cost-benefit framing is particularly clear and accessible. Technical Writing is advancing toward Advanced level. Encourage more user-facing work alongside this depth to build UX understanding.",
      scores: {
        Communication: 6,
        Leadership: 4,
        "Technical Writing": 6,
  ...
  },
  {
    ...
    type: "Presentation",
    description:
      "A fifteen-minute formal presentation delivered to a faculty panel of four academics and six invited industry guests from local software and consulting firms. The pitch covered the technical architecture of Aisha's capstone project — an AI-assisted academic advising tool — including a live demonstration of the natural language query interface, a discussion of the ethical considerations around algorithmic recommendation in education, and a market sizing analysis. Aisha handled all questions from the panel independently, including a technical deep-dive on the model fine-tuning pipeline and a challenge regarding data privacy compliance under UK GDPR.",
    competencies: ["Communication", "UX Empathy"],
    status: "Pending",
...
export const evaluations: Evaluation[] = [
  // Aisha — growing steadily; gaps remain in UX Empathy and Problem Solving
  {
    ...
    date: "2025-09-20",
    comment:
      "Good technical instincts early on. Communication is developing but still cautious in group settings.",
    scores: {
      Communication: 4,
      Leadership: 4,
      "Technical Writing": 4,
  ...
  },
  {
    ...
    date: "2025-11-15",
    comment:
      "Report quality has improved. Encourage more user-facing work to build UX understanding.",
    scores: {
      Communication: 6,
      Leadership: 4,
      "Technical Writing": 6,
  ...
  },
  {
    ...
    date: "2026-02-25",
    comment:
      "Solid progress in writing and communication. UX empathy and top-tier problem solving still need targeted work.",
    scores: {
      Communication: 8,
      Leadership: 6,
      "Technical Writing": 8,
  ...
  // Marcus — strong UX; leadership and problem solving are the remaining gaps
  {
    ...
    date: "2025-09-05",
    comment:
      "Genuine user-centred mindset. Defers too often in group decisions; needs to own more direction.",
    scores: {
      Communication: 4,
      Leadership: 4,
      "Technical Writing": 4,
  ...
  },
  {
    ...
    date: "2025-11-30",
    comment:
      "Workshop facilitation was a clear step up. Continue to push leadership and deepen technical problem solving.",
    scores: {
      Communication: 4,
      Leadership: 4,
      "Technical Writing": 6,
  ...
  },
  {
    ...
    date: "2026-02-10",
    comment:
      "Solid communicator and team player. Leadership adequate but aim for module ownership; PS still developing.",
    scores: {
      Communication: 6,
      Leadership: 6,
      "Technical Writing": 6,
  ...
  // Priya — exceptional PS; communication, leadership, and UX empathy lag behind
  {
    ...
    date: "2025-10-01",
    comment:
      "Exceptional engineering depth. Verbal explanations dense for non-experts; teamwork shows room to grow.",
    scores: {
      Communication: 4,
      Leadership: 4,
      "Technical Writing": 4,
  ...
  },
  {
    ...
    date: "2025-12-12",
    comment:
      "Hackathon results show creativity and strong PS. Practice clearer hand-off documentation and team inclusion.",
    scores: {
      Communication: 4,
      Leadership: 4,
      "Technical Writing": 6,
  ...
  },
  {
    ...
    date: "2026-03-05",
    comment:
      "Communication improved through retrospectives; teamwork now more reliable. Comm and leadership still below target.",
    scores: {
      Communication: 4,
      Leadership: 6,
      "Technical Writing": 6,
  ...
  // Pre-semester baselines (Jul 2025) + mid-year checkpoints — creates ~2-month-gap timeline data
  {
    ...
    date: "2025-07-10",
    comment:
      "Initial pre-year assessment. Good technical curiosity; collaborative and communication skills need structured development.",
    scores: {
      Communication: 2,
      Leadership: 2,
      "Technical Writing": 2,
  ...
  },
  {
    ...
    date: "2026-01-10",
    comment:
      "Mid-year check. Writing and communication showing clear improvement; UX empathy remains the priority gap.",
    scores: {
      Communication: 6,
      Leadership: 6,
      "Technical Writing": 6,
  ...
  },
  {
    ...
    date: "2025-07-12",
    comment:
      "Pre-year baseline. User empathy instincts are natural; leadership and technical writing need structured development.",
    scores: {
      Communication: 2,
      Leadership: 2,
      "Technical Writing": 2,
  ...
  },
  {
    ...
    date: "2025-12-20",
    comment:
      "Strong uplift since NHS project. Leadership growth encouraging; push for bolder ownership in group decisions.",
    scores: {
      Communication: 4,
      Leadership: 4,
      "Technical Writing": 6,
  ...
  },
  {
    ...
    date: "2025-07-20",
    comment:
      "Starting-point assessment. Problem solving is a standout; significant work needed on soft skills across the board.",
    scores: {
      Communication: 2,
      Leadership: 2,
      "Technical Writing": 2,
  ...
  },
  {
    ...
    date: "2025-11-15",
    comment:
      "Hackathon results demonstrate outstanding problem solving. Team dynamics and communication remain areas to address.",
    scores: {
      Communication: 4,
      Leadership: 4,
      "Technical Writing": 4,
